...
This guide gets a local ForkFlux coordination and audit layer running and shows how two AI agents can complete a structured workflow handoff through the ForkFlux MCP server.
