...
The command files are the canonical workflow instructions. Use the linked files above for command-specific behavior, and use [MCP Integration](mcp-integration.md#available-tools) for tool arguments and lifecycle details.
